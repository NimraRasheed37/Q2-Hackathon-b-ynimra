      ...
      <div className="max-w-5xl mx-auto flex flex-col lg:flex-row gap-20  items-center lg:items-start  overflow-hidden">
        ...
        <div className="md:w-1/2">
          <Image
            ...
            className="w-full h-auto md:w-[300px] md:h-[300px] lg:w-[675px] lg:h-[607px] object-fit"
            width={200}
            height={200}
          />
        </div>
        ...
        <div className="lg:w-1/2 p-6 flex flex-col justify-center items-start">
          <h2 className="text-xl md:text-3xl lg:text-6xl font-bold font-inter text-[#272343] mb-4 lg:mb-8">Library Stool Chair</h2>
